...
function oneClickPayment($productid=0)
{
	...
	<form  action="https://www.paypal.com/cgi-bin/webscr" id="order_submit_form" class="oneclick_payment_'.$productid.'" style="display:none;" method="post">
		<input type="hidden" name="cmd" value="_cart">
		<input type="hidden" name="add" value="1">
		<input type="hidden" name="business" value="'.$paypal_email.'">
		<input type="hidden" name="lc" value="US">
		<input type="hidden" name="item_name" value="'.$prodData['title'].'">
		<input type="hidden" name="item_number" value="1">
		<input type="hidden" name="amount" value="'.$prodData['sale_price'].'">
		<input type="hidden" name="shipping" value="0.00">	
		<input type="hidden" name="charset" value="utf-8" />
	  <input type="hidden" name="invoice" value="'.$productid.'" />
...
<form action="https://www.paypal.com/cgi-bin/webscr" id="order_submit_form" style="display:none;" method="post">
  ...
  <input type="hidden" name="invoice" value="'.$inputData['orderid'].'" />
	<input type="hidden" name="currency_code" value="'.strtoupper(FastEcommerce::$setting['currency']).'">
  <input type="hidden" name="return" value="'.System::getUrl().'" />
   <input type="hidden" name="notify_url" value="'.System::getUrl().'paymentapi/paypal/oneclick_notify" />
   <input type="hidden" name="cancel_return" value="'.System::getUrl().'paymentapi/paypal/oneclick_cancel" />
  <input type="hidden" name="rm" value="2" /> 
