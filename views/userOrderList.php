                        ...
                        if(isset($theList[0]['id']))
                        {
                            ...
                            for ($i=0; $i < $total; $i++) { 
                                ...
                                <tr>
                                    ...
                                    <a href="'.System::getUrl().'npanel/plugins/controller/fastecommerce/order/view/'.$theList[$i]['id'].'" class="btn btn-primary btn-sm" target="_blank">'.Lang::get('usercp/index.view').'</a>
                                    <button type="button" data-href="'.System::getUrl().'npanel/plugins/controller/fastecommerce/order/cancel/'.$theList[$i]['id'].'" class="btn btn-danger btn-customer-cancel-order btn-sm">'.Lang::get('usercp/index.cancel').'</button>
                                    </td>
                                </tr>
